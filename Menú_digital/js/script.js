...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedMode) {
        ...
        if (savedMode === 'blind' && savedBlindChoice) {
            ...
            // Modo ciego con subopción completa → aplicar directamente

            aplicarModo('blind', savedBlindChoice);

        } else if (savedMode === 'blind' && !savedBlindChoice) {

            // Estado incompleto (blind sin subopción) → limpiar y mostrar pantalla principal
